...
public class TestNewPostInputDescription {
    ...
    public void initValidTest() {
        textToInput = "This is a sample description";
    }

    @Test
    public void testDescriptionText() {
        // Type text
        onView(withId(R.id.description)).perform(typeText(textToInput), closeSoftKeyboard());

        // check that the text was changed
        onView(withId(R.id.description)).check(matches(withText(textToInput)));
    }
}